...
public class SoldProducts extends javax.swing.JFrame {
    ...
    private void fillCombo(){
        ...
        connect.fillCombo(product_list);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Record Sold Products");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        // TODO add your handling code here:
        if(amount_sold.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "amount can not be empty.");
        }
        else{
            String name = product_list.getSelectedItem().toString();
            String amount = amount_sold.getText();
            connect.add(name, amount);
            System.out.println(name + " , " + amount);
            JOptionPane.showMessageDialog(null, "Successfuly Done!");
        }
